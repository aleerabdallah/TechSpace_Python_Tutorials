...
```py title="Example of a single-line comment"
...
```py title="Example of a multi-line comment"
  # this function will output: Hello, World
  # this function will be ignored because everything after `#` is a comment
...
```py title="Example of accessing docstring"
print(sum.**doc**)

```

```py title="Example of using help() built-in function"
print(help(sum))
...
```py title="Example of documenting a function"
