...
```py title="example of basic assignment operator"
  >>> 
  >>> #
  >>> x = 10
  >>>
...
```py title="example of addition assignment operator"
  >>> 
  >>> # 
  >>> x = 18
  >>>
...
```py title="example of subtraction assignment operator"
  >>> 
  >>> # 
  >>> x = 20
  >>>
...
```py title="example of multiplication assignment operator"
  >>> 
  >>> #
  >>> x = 10
  >>> 
...
```py title="example of division assignment operator"
  >>> 
  >>> #
  >>> x = 10
  >>> 
...
```py title="example of floor dividion assignment operator"
  >>> 
  >>> #
  >>> x = 10
  >>>
...
```py title="example of modulus assignment operator"
  >>> 
  >>> # 
  >>> x = 9 
  >>>
